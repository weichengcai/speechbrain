...
def prepare_aishell_gender(
    ...
    """
    Prepares the json files for the AISHELL1 dataset.
    ...
    ---------
    data_folder : str
        Path to the folder where the AISHELL1 dataset is stored.
    save_json_train : str
    ...
    gender_dict = {}
    meta_data = os.path.join(data_folder, "resource_aishell", "speaker.info")
    with open(meta_data) as fa:
        for line in fa.readlines():
            line = line.strip()
            index, gender = line.split()
            index = "S" + index
            gender_dict[index] = gender


    # If the dataset doesn't exist yet, download it
    train_folder = os.path.join(data_folder, "data_aishell/wav", "train")
    val_folder = os.path.join(data_folder, "data_aishell/wav", "dev")
    test_folder = os.path.join(data_folder, "data_aishell/wav", "test")
...
if __name__ == "__main__":
   ...
   data_folder = '/data/aishell1/'
   prepare_aishell_gender(data_folder,
    "train.json",
    "valid.json",
    "test.json") 
